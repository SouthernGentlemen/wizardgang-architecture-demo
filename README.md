...
- [`docs/INTERACTIVE-DEMO-SPEC.md`](docs/INTERACTIVE-DEMO-SPEC.md) — historical interaction design context for R2, D1, i18n, WCAG, Git, webhooks, and GraphQL.
