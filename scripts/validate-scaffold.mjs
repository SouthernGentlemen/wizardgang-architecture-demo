...
const requiredRoutes = [
  ...
  '/governance', '/compliance', '/security', '/governance/concerns', '/dashboard', '/dashboard/uptime', '/dashboard/docs',
...
if (htmlDemos.length !== 22) failures.push(`expected 22 registered HTML demos; found ${htmlDemos.length}`);
