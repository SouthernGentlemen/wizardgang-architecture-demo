...
- Keep `/operations`, `/security`, `/health`, `/version`, `/__api/operations/logs`, `/__api/operations/cloudflare-usage`, `/admin`, and `/offline` reachable while intentionally offline.
