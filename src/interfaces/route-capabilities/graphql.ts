...
interfaceIdentityRoute({
  ...
  page: { parent: 'interfaces.index', label: 'GraphQL', summary: 'Working public query examples plus a locally bundled GraphiQL IDE.', order: 1, navigation: 'secondary', architectureMap: true },
}),
  interfaceIdentityRoute({
