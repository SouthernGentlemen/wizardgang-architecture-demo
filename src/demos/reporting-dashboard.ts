...
export async function renderUnifiedReportingPresentation(
  ...
  return `<section class="operations-section" id="reporting" aria-labelledby="reporting-heading">
    ...
    <p>Collection discovery comes from reporting ownership and registered capabilities. The operations surface does not select provider endpoints or interpret provider records.</p>
