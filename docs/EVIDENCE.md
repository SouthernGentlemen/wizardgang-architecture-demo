...
`/assurance/compliance` is the assurance posture front door across those sources and links into the evidence view for record-level inspection. It states the WCAG 2.2, ISO/IEC 27001, and ISO/IEC 42001 posture as aligned or supported and uncertified, then links to the canonical working evidence at `/demos#accessibility`, `/demos#i18n`, `/assurance/governance`, `/demos#mcp`, `/assurance/delivery`, and `/operations`. It does not reproduce their explanations or turn alignment into a certification claim.
