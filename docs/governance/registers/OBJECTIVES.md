...
| SEC-OBJ-001 | Release integrity | Keep every production deployment traceable to reviewed source. | Percentage of production deployments that identify immutable commit SHA, semantic tag/release, and deployment evidence. | 100% of production deployments. | Release owner | Git tags/releases, deploy workflow, /api/operations/version, docs/RELEASE.md, docs/EVIDENCE.md | Each release + quarterly | Active |
| SEC-OBJ-002 | Secret protection | Prevent credentials and secrets from entering public source or public evidence surfaces. | Confirmed secret exposures in repository, public logs, operational health/version responses, or public evidence. | 0 confirmed exposures. Any suspected exposure triggers immediate review and rotation decision. | Security owner | SECURITY.md, CI/security checks, public log behavior, incident/corrective-action records | Continuous + quarterly | Active |
