...
| Public assurance/compliance claim change | Evidence / Management-System Owner | Public reviewers/users | Focused `/assurance` checks, reporting APIs, docs, release/site content | Source/evidence mapping and controlled change |
